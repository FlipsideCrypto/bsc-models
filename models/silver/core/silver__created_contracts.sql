{{ config (
    ...
    post_hook = "ALTER TABLE {{ this }} ADD SEARCH OPTIMIZATION ON EQUALITY(block_timestamp, tx_hash, created_contract_address, creator_address), SUBSTRING(tx_hash, created_contract_address, creator_address)",
    tags = ['non_realtime']
) }}
