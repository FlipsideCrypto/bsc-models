...
WITH settings AS (
    ...
    SELECT
        ...
        '2022-10-21 03:40:37.000' AS end_date,
        '0xb3e3dfcb2d9f3dde16d78b9e6eb3538eb32b5ae1' AS main_address,
        '0x67c0a1fc3ec90aaa393adaea9cbe7230df3ec7ad' AS fee_address,
        '0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c' AS wrapped_native_address
),
raw AS (
    SELECT
        tx_hash,
